...
//	}
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		ClassPathResource ksFile = new ClassPathResource("server.jks");
		KeyStoreKeyFactory ksFactory = new KeyStoreKeyFactory(ksFile, "letmein".toCharArray());
		KeyPair keyPair = ksFactory.getKeyPair("mytestkey", "changeme".toCharArray());
//        PublicKey publicKey=new PublicKey()
//        KeyStoreKeyFactory keyStoreKeyFactory=new KeyStoreKeyFactory(new ClassPathResource("my-release-keys.keystore"), null);
